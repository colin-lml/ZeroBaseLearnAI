...
RNN通过循环来处理序列，但在处理长序列时可能存在梯度消失或爆炸的问题；而Transformer使用自注意力机制来处理序列，可以更高效地处理长序列，且不会出现梯度消失或爆炸的问题。
因此在自然语言处理领域中已经成为主流的模型架构，学习建议将更多时间花在Transformer架构上。

RNN 模型架构
RNN 举个自然语言的例子 
1. 去水果店买苹果  这里的“苹果”指的是水果
2. 去手机店买苹果  这里的“苹果”指的是 iphone手机
同样都是“苹果”但意思完全不同，这时要根据上下推出语意，也就是要设计一种能相连之前面数据神经网络模型,假设句子n已分好词了
1. “去” “水果店”   “买”   “苹果”    4组数据
2. “去” “手机店”   “买”   “苹果”    4组数据
